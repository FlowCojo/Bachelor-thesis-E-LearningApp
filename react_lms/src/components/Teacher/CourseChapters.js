        ...
        <div className='container mt-4 '>
            <div className='row'>
                ...
                <section className='col-md-9'>
                    <div className='card'>
                        <h5 className='card-header'>All Chapters ({totalResult}) <Link className='btn btn-success btn-sm float-end ' to={'/add-chapter/'+course_id}><i className="bi bi-folder-plus ">Add Chapter</i> </Link> </h5>
